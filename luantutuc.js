...
function LuanCachCucThaiDuong(keyArr) {
    ...
    if (lasoData.lasoOb[0].chi === "Sửu" && isHaiSaoDongCungTaiCung("Tài Bạch", "Mùi", "Thái Dương", "Thái Âm") ||
        lasoData.lasoOb[0].chi === "Sửu" && isHaiSaoDongCungTaiCung("Tử Tức", "Mùi", "Thái Dương", "Thái Âm")) {
    ...
    if (lasoData.lasoOb[0].chi === "Mùi" && isHaiSaoDongCungTaiCung("Tài Bạch", "Sửu", "Thái Dương", "Thái Âm") ||
        lasoData.lasoOb[0].chi === "Mùi" && isHaiSaoDongCungTaiCung("Tử Tức", "Sửu", "Thái Dương", "Thái Âm")) {
...
function LuanCachCucXuongKhuc(keyArr) {
    ...
    for (let i = 0; i < XuongKhuc.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", XuongKhuc[i])) {
            console.log(`${XuongKhuc[i]} toạ thủ cung Tử Tức`);
            keyArr.push(`${XuongKhuc[i]} toạ thủ cung Tử Tức`);
        }
    }
...
function LuanCachCucKhoiViet(keyArr) {
    ...
    for (let i = 0; i < KhoiViet.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", KhoiViet[i])) {
            console.log(`${KhoiViet[i]} toạ thủ cung Tử Tức`);
            keyArr.push(`${KhoiViet[i]} toạ thủ cung Tử Tức`);
...
function LuanCachCucLocTon(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Lộc Tồn")) {
        console.log("Lộc Tồn toạ thủ cung Tử Tức");
        keyArr.push("Lộc Tồn toạ thủ cung Tử Tức");
...
function LuanCachCucTaHuu(keyArr) {
    ...
    for (let i = 0; i < TaHuu.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", TaHuu[i])) {
            console.log(`${TaHuu[i]} toạ thủ cung Tử Tức`);
            keyArr.push(`${TaHuu[i]} toạ thủ cung Tử Tức`);
...
function LuanCachCucKinhDuongDaLa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Kình Dương")) {
        console.log("Kình Dương toạ thủ cung Tử Tức");
        keyArr.push("Kình Dương toạ thủ cung Tử Tức");
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Đà La")) {
        console.log("Đà La toạ thủ cung Tử Tức");
        keyArr.push("Đà La toạ thủ cung Tử Tức");
...
function LuanCachCucHoaLinh(keyArr) {
    ...
    for (let i = 0; i < HoaLinh.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", HoaLinh[i])) {
            console.log(`${HoaLinh[i]} toạ thủ cung Tử Tức`);
            keyArr.push(`${HoaLinh[i]} toạ thủ cung Tử Tức`);
...
function LuanCachCucKhongKiep(keyArr) {
    ...
    for (let i = 0; i < khongkiep.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", khongkiep[i])) {
            console.log(`${khongkiep[i]} toạ thủ cung Tử Tức`);
            keyArr.push(`${khongkiep[i]} toạ thủ cung Tử Tức`);
...
function LuanCachCucTuHoa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Hoá Lộc")) {
        console.log("Hoá Lộc toạ thủ cung Tử Tức");
        keyArr.push("Hoá Lộc toạ thủ cung Tử Tức");
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Hoá Quyền")) {
        console.log("Hoá Quyền toạ thủ cung Tử Tức");
        keyArr.push("Hoá Quyền toạ thủ cung Tử Tức");
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Hoá Khoa")) {
        console.log("Hoá Khoa toạ thủ cung Tử Tức");
        keyArr.push("Hoá Khoa toạ thủ cung Tử Tức");
    ...
    if (isSaoToaThuTaiCung("Tử Tức", "Hóa Kỵ")) {
        console.log("Hóa Kỵ toạ thủ cung Tử Tức");
        keyArr.push("Hóa Kỵ toạ thủ cung Tử Tức");
...
function LuanCachCucLucBaiTinh(keyArr) {
    ...
    for (let i = 0; i < songhao.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", songhao[i])) {

            console.log(songhao[i] + " toạ thủ tại cung Tử Tức");
            keyArr.push(songhao[i] + " toạ thủ tại cung Tử Tức");
    ...
    for (let i = 0; i < tangho.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", tangho[i])) {
            console.log("Cung Tử Tức có " + tangho[i]);
            keyArr.push("Cung Tử Tức có " + tangho[i]);
            for (let j = 0; j < tangho_dac.log; j++) {
                if (isSaoToaThuTaiCungVaChi("Tử Tức", tangho_dac[j], tangho[i])) {
                    console.log("Cung Tử Tức có " + tangho[i] + " toạ thủ cung Tử Tức tại " + tangho_dac[j]);
                    keyArr.push("Cung Tử Tức có " + tangho[i] + " toạ thủ cung Tử Tức tại " + tangho_dac[j]);
                }
            }
            if (lasoData.gioitinh === "Nữ") {
    ...
    for (let i = 0; i < khochu.length; i++) {
        if (isSaoToaThuTaiCung("Tử Tức", khochu[i])) {
            console.log(khochu[i] + " toạ thủ cung Tử Tức");
            keyArr.push(khochu[i] + " toạ thủ cung Tử Tức");
