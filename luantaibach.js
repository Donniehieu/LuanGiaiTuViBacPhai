...
function LuanCachCucSaoVuKhuc(keyArr) {
    ...
    if (isHaiSaoDongCungTaiCung("Tài Bạch", "Vũ Khúc", "Tham Lang")) {
        console.log("Vũ Khúc tọa thủ cung Tài Bạch đồng cung Tham Lang");
        keyArr.push("Vũ Khúc tọa thủ cung Tài Bạch đồng cung Tham Lang");
...
function LuanCachCucThaiDuong(keyArr) {
    ...
    if (isHaiSaoDongCungTaiCung("Tài Bạch", "Thái Dương", "Thái Âm")) {
        console.log("Thái Dương tọa thủ cung Tài Bạch đồng cung Thái Âm");
        keyArr.push("Thái Dương tọa thủ cung Tài Bạch đồng cung Thái Âm");

    }

    if (lasoData.lasoOb[0].chi === "Sửu" && isHaiSaoDongCungTaiCung("Tài Bạch", "Mùi", "Thái Dương", "Thái Âm") ||
        lasoData.lasoOb[0].chi === "Sửu" && isHaiSaoDongCungTaiCung("Tài Bạch", "Mùi", "Thái Dương", "Thái Âm")) {
    ...
    if (lasoData.lasoOb[0].chi === "Mùi" && isHaiSaoDongCungTaiCung("Tài Bạch", "Sửu", "Thái Dương", "Thái Âm") ||
        lasoData.lasoOb[0].chi === "Mùi" && isHaiSaoDongCungTaiCung("Tài Bạch", "Sửu", "Thái Dương", "Thái Âm")) {
...
function LuanCachCucXuongKhuc(keyArr) {
    ...
    for (let i = 0; i < XuongKhuc.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", XuongKhuc[i])) {
            console.log(`${XuongKhuc[i]} toạ thủ cung Tài Bạch`);
            keyArr.push(`${XuongKhuc[i]} toạ thủ cung Tài Bạch`);
        }
    }
...
function LuanCachCucKhoiViet(keyArr) {
    ...
    for (let i = 0; i < KhoiViet.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", KhoiViet[i])) {
            console.log(`${KhoiViet[i]} toạ thủ cung Tài Bạch`);
            keyArr.push(`${KhoiViet[i]} toạ thủ cung Tài Bạch`);
...
function LuanCachCucLocTon(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Lộc Tồn")) {
        console.log("Lộc Tồn toạ thủ cung Tài Bạch");
        keyArr.push("Lộc Tồn toạ thủ cung Tài Bạch");
...
function LuanCachCucTaHuu(keyArr) {
    ...
    for (let i = 0; i < TaHuu.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", TaHuu[i])) {
            console.log(`${TaHuu[i]} toạ thủ cung Tài Bạch`);
            keyArr.push(`${TaHuu[i]} toạ thủ cung Tài Bạch`);
...
function LuanCachCucKinhDuongDaLa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Kình Dương")) {
        console.log("Kình Dương toạ thủ cung Tài Bạch");
        keyArr.push("Kình Dương toạ thủ cung Tài Bạch");
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Đà La")) {
        console.log("Đà La toạ thủ cung Tài Bạch");
        keyArr.push("Đà La toạ thủ cung Tài Bạch");
...
function LuanCachCucHoaLinh(keyArr) {
    ...
    for (let i = 0; i < HoaLinh.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", HoaLinh[i])) {
            console.log(`${HoaLinh[i]} toạ thủ cung Tài Bạch`);
            keyArr.push(`${HoaLinh[i]} toạ thủ cung Tài Bạch`);
...
function LuanCachCucKhongKiep(keyArr) {
    ...
    for (let i = 0; i < khongkiep.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", khongkiep[i])) {
            console.log(`${khongkiep[i]} toạ thủ cung Tài Bạch`);
            keyArr.push(`${khongkiep[i]} toạ thủ cung Tài Bạch`);
...
function LuanCachCucTuHoa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Hoá Lộc")) {
        console.log("Hoá Lộc toạ thủ cung Tài Bạch");
        keyArr.push("Hoá Lộc toạ thủ cung Tài Bạch");
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Hoá Quyền")) {
        console.log("Hoá Quyền toạ thủ cung Tài Bạch");
        keyArr.push("Hoá Quyền toạ thủ cung Tài Bạch");
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Hoá Khoa")) {
        console.log("Hoá Khoa toạ thủ cung Tài Bạch");
        keyArr.push("Hoá Khoa toạ thủ cung Tài Bạch");
    ...
    if (isSaoToaThuTaiCung("Tài Bạch", "Hóa Kỵ")) {
        console.log("Hóa Kỵ toạ thủ cung Tài Bạch");
        keyArr.push("Hóa Kỵ toạ thủ cung Tài Bạch");
...
function LuanCachCucLucBaiTinh(keyArr) {
    ...
    for (let i = 0; i < songhao.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", songhao[i])) {

            console.log(songhao[i] + " toạ thủ tại cung Tài Bạch");
            keyArr.push(songhao[i] + " toạ thủ tại cung Tài Bạch");
    ...
    for (let i = 0; i < tangho.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", tangho[i])) {
            console.log("Cung Tài Bạch có " + tangho[i]);
            keyArr.push("Cung Tài Bạch có " + tangho[i]);
            for (let j = 0; j < tangho_dac.log; j++) {
                if (isSaoToaThuTaiCungVaChi("Tài Bạch", tangho_dac[j], tangho[i])) {
                    console.log("Cung Tài Bạch có " + tangho[i] + " toạ thủ cung Tài Bạch tại " + tangho_dac[j]);
                    keyArr.push("Cung Tài Bạch có " + tangho[i] + " toạ thủ cung Tài Bạch tại " + tangho_dac[j]);
                }
            }
            if (lasoData.gioitinh === "Nữ") {
    ...
    for (let i = 0; i < khochu.length; i++) {
        if (isSaoToaThuTaiCung("Tài Bạch", khochu[i])) {
            console.log(khochu[i] + " toạ thủ cung Tài Bạch");
            keyArr.push(khochu[i] + " toạ thủ cung Tài Bạch");
