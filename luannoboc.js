...
function LuanCachCucXuongKhuc(keyArr) {
    ...
    for (let i = 0; i < XuongKhuc.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", XuongKhuc[i])) {
            console.log(`${XuongKhuc[i]} toạ thủ cung Nô Bộc`);
            keyArr.push(`${XuongKhuc[i]} toạ thủ cung Nô Bộc`);
        }
    }
...
function LuanCachCucKhoiViet(keyArr) {
    ...
    for (let i = 0; i < KhoiViet.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", KhoiViet[i])) {
            console.log(`${KhoiViet[i]} toạ thủ cung Nô Bộc`);
            keyArr.push(`${KhoiViet[i]} toạ thủ cung Nô Bộc`);
...
function LuanCachCucTaHuu(keyArr) {
    ...
    for (let i = 0; i < TaHuu.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", TaHuu[i])) {
            console.log(`${TaHuu[i]} toạ thủ cung Nô Bộc`);
            keyArr.push(`${TaHuu[i]} toạ thủ cung Nô Bộc`);
...
function LuanCachCucKinhDuongDaLa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Kình Dương")) {
        console.log("Kình Dương toạ thủ cung Nô Bộc");
        keyArr.push("Kình Dương toạ thủ cung Nô Bộc");
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Đà La")) {
        console.log("Đà La toạ thủ cung Nô Bộc");
        keyArr.push("Đà La toạ thủ cung Nô Bộc");
...
function LuanCachCucHoaLinh(keyArr) {
    ...
    for (let i = 0; i < HoaLinh.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", HoaLinh[i])) {
            console.log(`${HoaLinh[i]} toạ thủ cung Nô Bộc`);
            keyArr.push(`${HoaLinh[i]} toạ thủ cung Nô Bộc`);
...
function LuanCachCucKhongKiep(keyArr) {
    ...
    for (let i = 0; i < khongkiep.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", khongkiep[i])) {
            console.log(`${khongkiep[i]} toạ thủ cung Nô Bộc`);
            keyArr.push(`${khongkiep[i]} toạ thủ cung Nô Bộc`);
...
function LuanCachCucTuHoa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Hoá Lộc")) {
        console.log("Hoá Lộc toạ thủ cung Nô Bộc");
        keyArr.push("Hoá Lộc toạ thủ cung Nô Bộc");
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Hoá Quyền")) {
        console.log("Hoá Quyền toạ thủ cung Nô Bộc");
        keyArr.push("Hoá Quyền toạ thủ cung Nô Bộc");
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Hoá Khoa")) {
        console.log("Hoá Khoa toạ thủ cung Nô Bộc");
        keyArr.push("Hoá Khoa toạ thủ cung Nô Bộc");
    ...
    if (isSaoToaThuTaiCung("Nô Bộc", "Hóa Kỵ")) {
        console.log("Hóa Kỵ toạ thủ cung Nô Bộc");
        keyArr.push("Hóa Kỵ toạ thủ cung Nô Bộc");
...
function LuanCachCucLucBaiTinh(keyArr) {
    ...
    for (let i = 0; i < songhao.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", songhao[i])) {

            console.log(songhao[i] + " toạ thủ tại cung Nô Bộc");
            keyArr.push(songhao[i] + " toạ thủ tại cung Nô Bộc");
    ...
    for (let i = 0; i < tangho.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", tangho[i])) {
            console.log("Cung Nô Bộc có " + tangho[i]);
            keyArr.push("Cung Nô Bộc có " + tangho[i]);
            for (let j = 0; j < tangho_dac.log; j++) {
                if (isSaoToaThuTaiCungVaChi("Nô Bộc", tangho_dac[j], tangho[i])) {
                    console.log("Cung Nô Bộc có " + tangho[i] + " toạ thủ cung Nô Bộc tại " + tangho_dac[j]);
                    keyArr.push("Cung Nô Bộc có " + tangho[i] + " toạ thủ cung Nô Bộc tại " + tangho_dac[j]);
                }
            }
            if (lasoData.gioitinh === "Nữ") {
    ...
    for (let i = 0; i < khochu.length; i++) {
        if (isSaoToaThuTaiCung("Nô Bộc", khochu[i])) {
            console.log(khochu[i] + " toạ thủ cung Nô Bộc");
            keyArr.push(khochu[i] + " toạ thủ cung Nô Bộc");
