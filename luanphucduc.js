...
function LuanCachCucCuMon(keyArr) {
    ...
    if (isSaoToaThuTaiCungVaChi("Phúc Đức", "Thân", "Cự Môn") && kiemTraCachCuc("Cự Môn", "Thái Dương") && isSaoToaThuTaiCung("Thiên Di", "Thái Dương")) {
        console.log("Cự Môn tọa thủ cung Phúc Đức ở Thân gặp Thái Dương, Thiên Di có Thái Dương");
        keyArr.push("Cự Môn tọa thủ cung Phúc Đức ở Thân gặp Thái Dương, Thiên Di có Thái Dương");
    }
    if (isSaoToaThuTaiCungVaChi("Phúc Đức", "Dần", "Cự Môn") && kiemTraCachCuc("Cự Môn", "Thái Dương") && isSaoToaThuTaiCung("Thiên Di", "Thái Dương")) {
        console.log("Cự Môn tọa thủ cung Phúc Đức ở Dần gặp Thái Dương, Thiên Di có Thái Dương");
        keyArr.push("Cự Môn tọa thủ cung Phúc Đức ở Dần gặp Thái Dương, Thiên Di có Thái Dương");

    }
    if (lasoData.lasoOb[0].chi === "Dần" && isHaiSaoDongCungTaiCung("Thiên Di", "Thái Dương", "Cự Môn")) {
        console.log("Cự Môn tọa thủ cung Thiên Di đồng cung Thái Dương xung chiếu cung Phúc Đức ở Dần");
        keyArr.push("Cự Môn tọa thủ cung Thiên Di đồng cung Thái Dương xung chiếu cung Phúc Đức ở Dần");
...
function LuanCachCucXuongKhuc(keyArr) {
    ...
    for (let i = 0; i < XuongKhuc.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", XuongKhuc[i])) {
            console.log(`${XuongKhuc[i]} toạ thủ cung Phúc Đức`);
            keyArr.push(`${XuongKhuc[i]} toạ thủ cung Phúc Đức`);
        }
    }
...
function LuanCachCucLocTon(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Phúc Đức", "Lộc Tồn")) {
        console.log("Lộc Tồn toạ thủ cung Phúc Đức");
        keyArr.push("Lộc Tồn toạ thủ cung Phúc Đức");
...
function LuanCachCucTaHuu(keyArr) {
    ...
    for (let i = 0; i < TaHuu.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", TaHuu[i])) {
            console.log(`${TaHuu[i]} toạ thủ cung Phúc Đức`);
            keyArr.push(`${TaHuu[i]} toạ thủ cung Phúc Đức`);
...
function LuanCachCucKinhDuongDaLa(keyArr) {
    ...
    if (isSaoToaThuTaiCung("Phúc Đức", "Đà La")) {
        console.log("Đà La toạ thủ cung Phúc Đức");
        keyArr.push("Đà La toạ thủ cung Phúc Đức");
...
function LuanCachCucHoaLinh(keyArr) {
    ...
    for (let i = 0; i < HoaLinh.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", HoaLinh[i])) {
            console.log(`${HoaLinh[i]} toạ thủ cung Phúc Đức`);
            keyArr.push(`${HoaLinh[i]} toạ thủ cung Phúc Đức`);
    ...
    if (isSaoToaThuTaiCung("Phúc Đức", "Hỏa Tinh") && isSaoToaThuTaiCung("Thiên Di", "Linh Tinh")) {
        console.log("Hỏa Tinh toạ thủ cung Phúc Đức gặp Linh Tinh ở Thiên Di");
        keyArr.push("Hỏa Tinh toạ thủ cung Phúc Đức gặp Linh Tinh ở Thiên Di");
    ...
    if (isSaoToaThuTaiCung("Phúc Đức", "Linh Tinh") && isSaoToaThuTaiCung("Thiên Di", "Hỏa Tinh")) {
        console.log("Linh Tinh toạ thủ cung Phúc Đức gặp Hỏa Tinh ở Thiên Di");
        keyArr.push("Linh Tinh toạ thủ cung Phúc Đức gặp Hỏa Tinh ở Thiên Di");
...
function LuanCachCucKhongKiep(keyArr) {
    ...
    for (let i = 0; i < khongkiep.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", khongkiep[i])) {
            console.log(`${khongkiep[i]} toạ thủ cung Phúc Đức`);
            keyArr.push(`${khongkiep[i]} toạ thủ cung Phúc Đức`);
...
function LuanCachCucTuHoa(keyArr) {
    ...
    for (let i = 0; i < dinhky.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", "Hoá Lộc") && isSaoToaThuTaiCung("Thiên Di", "Lộc Tồn") && lasoData.canNam === dk[i]) {
            console.log("Người tuổi " + dinhky[i] + " có Hoá Lộc toạ thủ cung Phúc Đức gặp Lộc Tồn ở Thiên Di");
            keyArr.push("Người tuổi " + dinhky[i] + " có Hoá Lộc toạ thủ cung Phúc Đức gặp Lộc Tồn ở Thiên Di");
        }
    }
...
function LuanCachCucLucBaiTinh(keyArr) {
    ...
    for (let i = 0; i < songhao.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", songhao[i])) {
            ...
            console.log(songhao[i] + " toạ thủ tại cung Phúc Đức");
            keyArr.push(songhao[i] + " toạ thủ tại cung Phúc Đức");
    ...
    for (let i = 0; i < tangho.length; i++) {
        if (isSaoToaThuTaiCung("Phúc Đức", tangho[i])) {
            console.log("Cung Phúc Đức có " + tangho[i]);
            keyArr.push("Cung Phúc Đức có " + tangho[i]);
            for (let j = 0; j < tangho_dac.log; j++) {
                if (isSaoToaThuTaiCungVaChi("Phúc Đức", tangho_dac[j], tangho[i])) {
                    console.log("Cung Phúc Đức có " + tangho[i] + " toạ thủ cung Phúc Đức tại " + tangho_dac[j]);
                    keyArr.push("Cung Phúc Đức có " + tangho[i] + " toạ thủ cung Phúc Đức tại " + tangho_dac[j]);
                }
            }
            if (lasoData.gioitinh === "Nữ") {
